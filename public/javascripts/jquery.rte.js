    ...
    function toolbar(iframe) {
        ...
        var tb = $("<div class='rte-toolbar' id='toolbar-"+iframe.title+"'><div>\
            ...
            <p>\
                ...
                <a href='#' class='underline'><img src='"+media_url+"underline.gif' alt='underline' /></a>\
            </p>\
            <p>\
                <a href='#' class='orderedlist'><img src='"+media_url+"ordered.gif' alt='ordered list' /></a>\
                <a href='#' class='unorderedlist'><img src='"+media_url+"unordered.gif' alt='unordered list' /></a>\
            </p>\
            <p>\
                <a href='#' class='alignleft'><img src='"+media_url+"left.gif' alt='align left' /></a>\
                <a href='#' class='aligncenter'><img src='"+media_url+"center.gif' alt='align center' /></a>\
                <a href='#' class='alignright'><img src='"+media_url+"right.gif' alt='align right' /></a>\
                <a href='#' class='alignjustify'><img src='"+media_url+"justify.gif' alt='align justify' /></a>\
            </p>\
            <p>\
                <a href='#' class='link'><img src='"+media_url+"link.gif' alt='link' /></a>\
                <a href='#' class='image'><img src='"+media_url+"image.gif' alt='image' /></a>\
            </p></div></div>");
        ...
        $('.alignjustify', tb).click(function(){ formatText(iframe, 'justifyFull');return false; });
